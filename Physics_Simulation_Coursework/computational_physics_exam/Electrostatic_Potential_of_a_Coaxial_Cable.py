...
# 3. الحل العددي باستخدام طريقة جاكوبي
max_iter = 4000 # عدد التكرارات 4000 (لزيادة الدقة واقترب النظام من الاتزان)
...
# 5. الرسوم البيانية لمقارنة النتائج
